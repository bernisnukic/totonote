...
TotoNote is a local-first desktop app for organising lore and world-building notes.
Everything lives in a single SQLite file on your own machine — no account, no cloud, works
offline.
...
Found a bug or want to ask something? Open an issue on
[GitHub](https://github.com/bernisnukic/totonote/issues).

---

*These pages describe the current release. If something here doesn't match what you see,
grab the latest build from
[Releases](https://github.com/bernisnukic/totonote/releases).*
